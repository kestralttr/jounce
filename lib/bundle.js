...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function(){
	  ...
	  // const INSTRUCTIONS = "You have been transported to 1980's cyberspace and now have to escape. Guide your ship along the lines, making sure to pick up all the energy balls so that you don't lose power. Watch out, the more energy you gather, the faster you'll go... Left = Left Arrow Key Right = Right Arrow Key Start = Spacebar Pause = P Good luck.";
	  //
